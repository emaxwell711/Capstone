...
import com.example.falluserstudy2019_v2.Polygons.Bar4DPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar4DBehavior extends SlideBehaviorPolygon {

    public Bar4DBehavior(SlideController sc) {
        super(R.drawable.bar4d, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar4DPolygons poly = new Bar4DPolygons();
...
//         sa.drawPolygon(poly.ZERO_LINE);
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar4DPolygons poly, SlideActivity sa, String action) {
