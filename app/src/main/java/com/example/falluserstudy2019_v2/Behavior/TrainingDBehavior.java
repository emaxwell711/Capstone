...
import com.example.falluserstudy2019_v2.Polygons.TrainingDPolygons;
import com.example.falluserstudy2019_v2.R;

public class TrainingDBehavior extends SlideBehaviorPolygon {

    public TrainingDBehavior(SlideController sc) {
        super(R.drawable.trainingd, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
         TrainingDPolygons poly = new TrainingDPolygons();
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, TrainingDPolygons poly, SlideActivity sa, String action) {
