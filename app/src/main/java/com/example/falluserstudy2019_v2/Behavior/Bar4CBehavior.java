...
import com.example.falluserstudy2019_v2.Polygons.Bar4CPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar4CBehavior extends SlideBehaviorPolygon {

    public Bar4CBehavior(SlideController sc) {
        super(R.drawable.bar4ce, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar4CPolygons poly = new Bar4CPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar4CPolygons poly, SlideActivity sa, String action) {
