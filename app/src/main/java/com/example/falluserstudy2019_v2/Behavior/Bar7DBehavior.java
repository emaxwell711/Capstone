...
import com.example.falluserstudy2019_v2.Polygons.Bar7DPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar7DBehavior extends SlideBehaviorPolygon {

    public Bar7DBehavior(SlideController sc) {
        super(R.drawable.bar7d, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//        Bar7DPolygons poly = new Bar7DPolygons();
...
//        sa.drawPolygon(poly.ZERO_LINE);
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar7DPolygons poly, SlideActivity sa, String action) {
