...
import com.example.falluserstudy2019_v2.Polygons.Bar5DPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar5DBehavior extends SlideBehaviorPolygon {

    public Bar5DBehavior(SlideController sc) {
        super(R.drawable.bar5de, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar5DPolygons poly = new Bar5DPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar5DPolygons poly, SlideActivity sa, String action) {
