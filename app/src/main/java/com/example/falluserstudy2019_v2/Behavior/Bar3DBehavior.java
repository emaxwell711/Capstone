...
import com.example.falluserstudy2019_v2.Polygons.Bar3DPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar3DBehavior extends SlideBehaviorPolygon {

    public Bar3DBehavior(SlideController sc) {
        super(R.drawable.bar3d, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar3DPolygons poly = new Bar3DPolygons();
...
//         sa.drawPolygon(poly.ZERO_LINE);
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar3DPolygons poly, SlideActivity sa, String action) {
