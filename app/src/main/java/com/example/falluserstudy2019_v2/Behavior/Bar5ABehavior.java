...
import com.example.falluserstudy2019_v2.Polygons.Bar5APolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar5ABehavior extends SlideBehaviorPolygon {

    public Bar5ABehavior(SlideController sc) {
        super(R.drawable.bar5ae, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar5APolygons poly = new Bar5APolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar5APolygons poly, SlideActivity sa, String action) {
