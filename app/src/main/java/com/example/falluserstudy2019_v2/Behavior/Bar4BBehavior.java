...
import com.example.falluserstudy2019_v2.Polygons.Bar4BPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar4BBehavior extends SlideBehaviorPolygon {

    public Bar4BBehavior(SlideController sc) {
        super(R.drawable.bar4be, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar4BPolygons poly = new Bar4BPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar4BPolygons poly, SlideActivity sa, String action) {
