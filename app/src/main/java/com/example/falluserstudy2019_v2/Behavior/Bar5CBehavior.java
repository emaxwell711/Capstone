...
import com.example.falluserstudy2019_v2.Polygons.Bar5CPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar5CBehavior extends SlideBehaviorPolygon {

    public Bar5CBehavior(SlideController sc) {
        super(R.drawable.bar5c, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar5CPolygons poly = new Bar5CPolygons();
...
//         sa.drawPolygon(poly.ZERO_LINE);
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar5CPolygons poly, SlideActivity sa, String action) {
