...
import com.example.falluserstudy2019_v2.Polygons.Bar6BPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar6BBehavior extends SlideBehaviorPolygon {

    public Bar6BBehavior(SlideController sc) {
        super(R.drawable.bar6be, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//        Bar6BPolygons poly = new Bar6BPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar6BPolygons poly, SlideActivity sa, String action) {
