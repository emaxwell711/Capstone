...
import com.example.falluserstudy2019_v2.Polygons.Bar7BPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar7BBehavior extends SlideBehaviorPolygon {

    public Bar7BBehavior(SlideController sc) {
        super(R.drawable.bar7be, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//        Bar7BPolygons poly = new Bar7BPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar7BPolygons poly, SlideActivity sa, String action) {
