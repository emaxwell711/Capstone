...
import com.example.falluserstudy2019_v2.Polygons.Bar5BPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar5BBehavior extends SlideBehaviorPolygon {

    public Bar5BBehavior(SlideController sc) {
        super(R.drawable.bar5b, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar5BPolygons poly = new Bar5BPolygons();
...
//         sa.drawPolygon(poly.ZERO_LINE);
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar5BPolygons poly, SlideActivity sa, String action) {
