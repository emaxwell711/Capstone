...
import com.example.falluserstudy2019_v2.Polygons.Bar3BPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar3BBehavior extends SlideBehaviorPolygon {

    public Bar3BBehavior(SlideController sc) {
        super(R.drawable.bar3be, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         Bar3BPolygons poly = new Bar3BPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar3BPolygons poly, SlideActivity sa, String action) {
