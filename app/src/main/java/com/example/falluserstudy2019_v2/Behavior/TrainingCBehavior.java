...
import com.example.falluserstudy2019_v2.Polygons.TrainingCPolygons;
import com.example.falluserstudy2019_v2.R;

public class TrainingCBehavior extends SlideBehaviorPolygon {

    public TrainingCBehavior(SlideController sc) {
        super(R.drawable.trainingce, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//         TrainingCPolygons poly = new TrainingCPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, TrainingCPolygons poly, SlideActivity sa, String action) {
