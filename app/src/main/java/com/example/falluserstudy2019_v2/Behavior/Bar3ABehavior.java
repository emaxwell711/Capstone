...
import com.example.falluserstudy2019_v2.Polygons.Bar3APolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar3ABehavior extends SlideBehaviorPolygon {

    public Bar3ABehavior(SlideController sc) {
        super(R.drawable.bar3a, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//        Bar3APolygons poly = new Bar3APolygons();
...
//        sa.drawPolygon(poly.ZERO_LINE);
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar3APolygons poly, SlideActivity sa, String action) {
