...
import com.example.falluserstudy2019_v2.Polygons.Bar6APolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar6ABehavior extends SlideBehaviorPolygon {

    public Bar6ABehavior(SlideController sc) {
        super(R.drawable.bar6a, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//        Bar6APolygons poly = new Bar6APolygons();
...
//        sa.drawPolygon(poly.ZERO_LINE);
    ...
    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar6APolygons poly, SlideActivity sa, String action) {
