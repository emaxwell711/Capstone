...
import com.example.falluserstudy2019_v2.Polygons.Bar7CPolygons;
import com.example.falluserstudy2019_v2.R;

public class Bar7CBehavior extends SlideBehaviorPolygon {

    public Bar7CBehavior(SlideController sc) {
        super(R.drawable.bar7ce, sc);
    }

    @Override
    public void drawPolygons(SlideActivity sa) {
//        Bar7CPolygons poly = new Bar7CPolygons();
...
//    }
//
//    private boolean handleGrids(String sAdd, int x, int y, Bitmap bitmap, int width, Bar7CPolygons poly, SlideActivity sa, String action) {
